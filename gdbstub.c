...
void* regptr(int regno, struct debug_args* debug_args) {
    ...
    switch (regno) {
        ...
        case GDB_CPU_X86_64_REG_RAX: reg_ptr = &debug_args->regs.rax; break;
        case GDB_CPU_X86_64_REG_RBX: reg_ptr = &debug_args->regs.rbx; break;
        case GDB_CPU_X86_64_REG_RCX: reg_ptr = &debug_args->regs.rcx; break;
        case GDB_CPU_X86_64_REG_RDX: reg_ptr = &debug_args->regs.rdx; break;
        case GDB_CPU_X86_64_REG_RSI: reg_ptr = &debug_args->regs.rsi; break;
        case GDB_CPU_X86_64_REG_RDI: reg_ptr = &debug_args->regs.rdi; break;
        case GDB_CPU_X86_64_REG_RBP: reg_ptr = &debug_args->regs.rbp; break;
        case GDB_CPU_X86_64_REG_RSP: reg_ptr = &debug_args->regs.rsp; break;
        
        /* Additional 64-bit registers */
        case GDB_CPU_X86_64_REG_R8: reg_ptr = &debug_args->regs.r8; break;
        case GDB_CPU_X86_64_REG_R9: reg_ptr = &debug_args->regs.r9; break;
        case GDB_CPU_X86_64_REG_R10: reg_ptr = &debug_args->regs.r10; break;
        case GDB_CPU_X86_64_REG_R11: reg_ptr = &debug_args->regs.r11; break;
        case GDB_CPU_X86_64_REG_R12: reg_ptr = &debug_args->regs.r12; break;
        case GDB_CPU_X86_64_REG_R13: reg_ptr = &debug_args->regs.r13; break;
        case GDB_CPU_X86_64_REG_R14: reg_ptr = &debug_args->regs.r14; break;
        case GDB_CPU_X86_64_REG_R15: reg_ptr = &debug_args->regs.r15; break;
        
        /* Instruction pointer */
        case GDB_CPU_X86_64_REG_RIP: reg_ptr = &debug_args->regs.rip; break;
        
        /* Flags register */
        case GDB_CPU_X86_64_REG_EFLAGS: reg_ptr = &debug_args->regs.rflags; break;
        
        /* Segment registers */
        case GDB_CPU_X86_64_REG_CS: reg_ptr = &debug_args->sregs.cs; break;
        case GDB_CPU_X86_64_REG_SS: reg_ptr = &debug_args->sregs.ss; break;
        case GDB_CPU_X86_64_REG_DS: reg_ptr = &debug_args->sregs.ds; break;
        case GDB_CPU_X86_64_REG_ES: reg_ptr = &debug_args->sregs.es; break;
        case GDB_CPU_X86_64_REG_FS: reg_ptr = &debug_args->sregs.fs; break;
        case GDB_CPU_X86_64_REG_GS: reg_ptr = &debug_args->sregs.gs; break;
        
        /* FPU ST registers (80-bit floating point) */
        case GDB_CPU_X86_64_REG_ST0: reg_ptr = debug_args->fpu.fpr[0]; break;
        case GDB_CPU_X86_64_REG_ST1: reg_ptr = debug_args->fpu.fpr[1]; break;
        case GDB_CPU_X86_64_REG_ST2: reg_ptr = debug_args->fpu.fpr[2]; break;
        case GDB_CPU_X86_64_REG_ST3: reg_ptr = debug_args->fpu.fpr[3]; break;
        case GDB_CPU_X86_64_REG_ST4: reg_ptr = debug_args->fpu.fpr[4]; break;
        case GDB_CPU_X86_64_REG_ST5: reg_ptr = debug_args->fpu.fpr[5]; break;
        case GDB_CPU_X86_64_REG_ST6: reg_ptr = debug_args->fpu.fpr[6]; break;
        case GDB_CPU_X86_64_REG_ST7: reg_ptr = debug_args->fpu.fpr[7]; break;
        
        /* FPU control registers */
        case GDB_CPU_X86_64_REG_FCTRL: reg_ptr = &debug_args->fpu.fcw; break;
        case GDB_CPU_X86_64_REG_FSTAT: reg_ptr = &debug_args->fpu.fsw; break;
        case GDB_CPU_X86_64_REG_FTAG: reg_ptr = &debug_args->fpu.ftwx; break;
        case GDB_CPU_X86_64_REG_FISEG: reg_ptr = NULL; break;
        case GDB_CPU_X86_64_REG_FIOFF: reg_ptr = &debug_args->fpu.last_ip; break;
        case GDB_CPU_X86_64_REG_FOSEG: reg_ptr = NULL; break;
        case GDB_CPU_X86_64_REG_FOOFF: reg_ptr = &debug_args->fpu.last_dp; break;
        case GDB_CPU_X86_64_REG_FOP: reg_ptr = &debug_args->fpu.last_opcode; break;
        
        /* SSE registers (XMM) */
        case GDB_CPU_X86_64_REG_XMM0: reg_ptr = debug_args->fpu.xmm[0]; break;
        case GDB_CPU_X86_64_REG_XMM1: reg_ptr = &debug_args->fpu.xmm[1]; break;
        case GDB_CPU_X86_64_REG_XMM2: reg_ptr = &debug_args->fpu.xmm[2]; break;
        case GDB_CPU_X86_64_REG_XMM3: reg_ptr = &debug_args->fpu.xmm[3]; break;
        case GDB_CPU_X86_64_REG_XMM4: reg_ptr = &debug_args->fpu.xmm[4]; break;
        case GDB_CPU_X86_64_REG_XMM5: reg_ptr = &debug_args->fpu.xmm[5]; break;
        case GDB_CPU_X86_64_REG_XMM6: reg_ptr = &debug_args->fpu.xmm[6]; break;
        case GDB_CPU_X86_64_REG_XMM7: reg_ptr = &debug_args->fpu.xmm[7]; break;
        case GDB_CPU_X86_64_REG_XMM8: reg_ptr = &debug_args->fpu.xmm[8]; break;
        case GDB_CPU_X86_64_REG_XMM9: reg_ptr = &debug_args->fpu.xmm[9]; break;
        case GDB_CPU_X86_64_REG_XMM10: reg_ptr = &debug_args->fpu.xmm[10]; break;
        case GDB_CPU_X86_64_REG_XMM11: reg_ptr = &debug_args->fpu.xmm[11]; break;
        case GDB_CPU_X86_64_REG_XMM12: reg_ptr = &debug_args->fpu.xmm[12]; break;
        case GDB_CPU_X86_64_REG_XMM13: reg_ptr = &debug_args->fpu.xmm[13]; break;
        case GDB_CPU_X86_64_REG_XMM14: reg_ptr = &debug_args->fpu.xmm[14]; break;
        case GDB_CPU_X86_64_REG_XMM15: reg_ptr = &debug_args->fpu.xmm[15]; break;
        
        /* SSE control register */
        case GDB_CPU_X86_64_REG_MXCSR: reg_ptr = &debug_args->fpu.mxcsr; break;
        ...
        case GDB_CPU_X86_64_REG_YMM15: reg_ptr = NULL; break;
    }
    return reg_ptr;
}
